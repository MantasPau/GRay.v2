        ...
        for (int b = -11; b < 11; ++b)
        {
            ...
            if ((center - Math::Point3(4, 0.2, 0)).length() > 0.9)
            {
                ...
                if(chooseMat < 0.8)
                {
                    ...
                    auto center2 = center + Math::Vec3(0, Utils::randomDouble(0, 0.5), 0);
                    world.add(make_shared<Solids::MovingSphere>(center, center2, 0.0, 1.0, 0.2, sphereMaterial));
                }
...
int main(int argc, char * argv[])
{
    ...
    Camera cam(lookFrom, lookAt, {0, 1, 0}, 20, aspectRatio, 0.1, distToFocus, 0.0, 1.0);
    //Render
