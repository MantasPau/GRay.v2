...
int main(int argc, char * argv[])
{
    ...
    double vfov = 40.0;
    double aperture = 0.0;
    Solids::Background background(make_shared<Materials::ImageTextureHDRI>(argv[1]), 2);
    ...
    std::cerr << 13-(1.5-atoi(argv[2])/200.0) << std::endl;
    switch(1)
    {
        case 1:
            world = randomScene();
            //background = Solids::Background(Math::Color(0.7, 0.8, 1.0));
            lookFrom = Math::Point3(13-(1.5-atoi(argv[2])/200.0), 2, 3);
